...
function AletheiaLogo() {
  ...
  // roughly x:69-145, y:143.76-186.93 (ECG waveform peaks to letter bottoms).
  // viewBox starts at Y=142 with ~1.76 units padding above the highest peak.
  // Container aspect ratio (80/49.5 = 1.616) matches viewBox ratio (76/47 = 1.617)
  // to prevent distortion since react-pdf does not support preserveAspectRatio.
  return (
    <Svg width={80} height={49.5} viewBox="69 142 76 47">
